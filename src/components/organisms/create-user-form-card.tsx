...
export function CreateUserFormCard() {
  ...
  const onSubmit: SubmitHandler<CreateUserFormData> = () => undefined;
      ...
      <div className="w-full max-w-md rounded-none lg:w-1/2 lg:max-w-none">
        ...
        <FormProvider {...methods}>
          <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button
              type="submit"
              className="h-12 w-full rounded-none text-base font-semibold shadow-lg shadow-brand-action/20 transition-transform duration-200 hover:-translate-y-0.5"
            >
              Criar conta
